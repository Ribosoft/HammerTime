...
var renderInputError = function(clientMessage, consoleMessage, next) {
    renderError(clientMessage, consoleMessage || "This should have been handled on client side", next);
};

var renderDatabaseError = function(clientMessage, consoleMessage, next) {
    renderError(clientMessage, consoleMessage || clientMessage, next);
};

var renderInternalError = function(clientMessage, consoleMessage, next) {
    renderError(clientMessage, consoleMessage || "Something went wrong on the server.", next);
};
