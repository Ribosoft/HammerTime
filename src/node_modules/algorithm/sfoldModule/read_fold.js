...
ParseUtilities.ParseSFoldResults = function (directory, cutsiteType, numberOfCandidates) {
    ...
    //TODO: Find ID
    var file_pattern_begin = directory + cutsiteType;
    ...
    for (var struct_num = 0; struct_num < 200; struct_num++) 
    {
        ...
        {
            Log("No more files for cutsite type " + cutsiteType + ", request " + directory, "ParseUtilities.ParseSFoldResults", 1);
            break; //ran out of files
        }

        var Structs = ParseUtilities.ParseStructuresSummary(file);
        for (var ii = 1; ii <= 10; ++ii) //Structure files are 1 based, arrays are zero based. (always 10 files
        {
