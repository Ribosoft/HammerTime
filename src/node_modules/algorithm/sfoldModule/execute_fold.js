...
SFOLD_COMMAND = '/home/admin/sfold/bin/sfold';
UNAFOLD_COMMAND = '/home/admin/unafold/exe/bin/UNAFold.pl'
...
var SFOLD_COMMAND = server ? SFOLD_COMMAND : 'sfold.exe';
var UNAFOLD_COMMAND = UNAFOLD_COMMAND;
...
Fold.SFold = function( sequenceFile, targetFolder , reportObj ,constraintFile , callbackArg )
{
	...
	else
	{
	    ...
	    setTimeout(function () { Fold.SFold(sequenceFile, targetFolder, reportObj, constraintFile, callbackArg); }, 4000); //Attempt to execute the fold again in 4 seconds
	}
