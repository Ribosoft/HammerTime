...
var MELTING_LOWERBOUND = 5 +273; //That is 5 degrees below environment T
var MELTING_UPPERBOUND = 20 + 273; //That is 5 degrees below environment T
...
function CleanseCandidates(rawCandidatesPerCutsite,prefs)
{
    ...
    for (var ii = 0; ii < rawCandidatesPerCutsite.length; ++ii)
    {
        ...
        for (var jj = 0; jj < cutsiteCandidates.length ; ++jj)
        {
            ...
            var meltingT = MeltingTCalc.tm_Salt_Adjusted(seqToCompute, prefs.naEnv + prefs.mgEnv); //MUST BE IN mM
