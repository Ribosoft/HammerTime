...
function _handleRequestPart2(reportObject) 
{
    ...
    {
        var cutsiteTypeContainer = request.CutsiteTypesCandidateContainer[ii];
...
function _handleRequestPart4(reportObj) {
    ...
    for (var ii = 0; ii < cutsiteTypes.length; ++ii) {
        ...
        for (var jj = 0; jj < cutsiteTypeContainer.length; ++jj) {
            ...
            var file_pattern_begin = request.ID + '\\' + cutsiteTypeContainer.Cutsites[jj].ID + '\\';
            ...
            var index = jj;
            Log("Sending parse request for " + cutsiteTypeContainer.Cutsites[jj].ID + ' target shape with constraints', 'HandleRequestPart4 execution', 1);
            ...
            (
                ...
                500,
                [cutsiteTypeContainer.Cutsites[jj], fileSummary, fileStructures, reportObj]
            );//Execute Async
        }
    }
